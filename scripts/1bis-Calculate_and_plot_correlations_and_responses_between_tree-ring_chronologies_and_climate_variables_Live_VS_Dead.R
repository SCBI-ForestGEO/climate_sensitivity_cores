...
dir.create("results/live_vs_dead/climate/", showWarnings = F)

write.csv(mean_and_std_of_clim, file = "results/live_vs_dead/climate/mean_and_std_of_climate_variables.csv", row.names = F)
